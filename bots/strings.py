lang_dict = {
    ...
    "type product comment": [
        "Mahsulot haqida qo'shimcha tafsilotlar", 
    ...
    "click search button": [
        "[Qidiruv] tugmasi orqali mahsulotlarni izlashingiz mumkin", 
        "Вы можете найти товары с помощью кнопки [Поиск]"
        ],
    ...
    "your supply is accepted": [
        "✅ Sizning shartlaringiz qabul qilindi. Siz ushbu tovarni ta'minlashingiz kerak", 
